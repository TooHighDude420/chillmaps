        ...
        <div className="flex flex-col items-center w-full">
            <div className="w-[90%] h-[50vh] rounded-b-2xl flex flex-col justify-between bg-[#0a2a2d]">
                ...
                <div className="h-[10vh] w-full flex gap-x-5 py-2 justify-center items-center">
                    <button className="h-[80%] w-[10%] rounded-2xl bg-amber-800" onClick={() => { setPage("posts") }}>posts</button>
                    <button className="h-[80%] w-[10%] rounded-2xl bg-amber-800" onClick={() => { setPage("settings") }}>settings</button>
            ...
            <div className="overflow-y-scroll w-[80%] h-[80vh] py-6 no-scrollbar">
                {user ?
                    page == "posts" ? <ProfilePosts user={user} /> : <ProfileSettings cUser={user} />
                    : <p></p>
                }
            </div>
